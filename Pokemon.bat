...
echo   \           Ported by Domenico Valentino            \
echo    \---------------------------------------------------\
pause
...
echo Type 1 to restart
echo Type 2 to go back to Domis Game Spot
echo Type 3 to exit
set /p leave1=-
if %leave1%==1 goto welcome
if %leave1%==2 goto gamespot
if %leave1%==3 goto end
